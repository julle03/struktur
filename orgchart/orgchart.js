...
(function ($) {
	...
	function buildNode($node, $appendTo, level, opts) {
		...
		if ($childNodesCount > 0) {
			...
			$nodeCell.append('<div><img class="cover" src="examples/images/orgchart.minus.png"/></div>');
		}
		...
		if ($childNodesCount > 0) {
			$nodeDiv.next().children('img.cover').click(function () {
				...
				if ($tr.hasClass('contracted')) {
					...
					$(this).attr('src', 'examples/images/orgchart.minus.png');
					...
					$(this).attr('src', 'examples/images/orgchart.plus.png');
